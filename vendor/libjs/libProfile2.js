...
var save_method;
var urlSave = ''; 
var tbPendidikan = $('#table_profil_pendidikan');
var tbKeluarga = $('#table_profil_keluarga');
var tbPekerjaan = $('#table_riwayat_pekerjaan');
var tbProfil = $('#table_profil');
        ...
        success: function(resp)
        {
          if (resp.status) {
            ...
            resp.data['foto'] ? setFotoUser('upload_img/user_img/'+resp.data['foto']) : '';
             ...
             loadDataTable(tbProfil);
            loadDataTable(tbPendidikan);
                loadDataTable(tbKeluarga);
                loadDataTable(tbPekerjaan);
          }
          else {
...
function loadJenjangPendidikan(){
  $('#jenjang').load(site_url+class_url+'/select_jenjang_pendidikan');
}
