...
var tbStatus= $('#table_status');
var tbGolongan = $('#table_golongan');
  ...
  $.ajax({
        ...
        success: function(resp)
        {
          if (resp.status) {
            ...
            loadDataTable(tbStatus);
                loadDataTable(tbGolongan);
          }
          else {
...
function loadStatusSdm(){
  $('#id_status').load(site_url+class_url+'/select_status');
}
function loadGolonganSdm(){
  $('#id_golongan').load(site_url+class_url+'/select_golongan');
}
