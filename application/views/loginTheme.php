...
<body>
                        ...
                        <div class="bg-primary bg-soft">
                            <div class="row">
                                ...
                                <div class="col-5 align-self-end">
                                    <img src="<?= base_url() ;?>vendor/assets/images/profile-img.png" alt="" class="img-fluid">
                                </div>
                            </div>
                        </div>
                        <div class="card-body pt-0">
                            <div class="auth-logo">
                                <a href="index.html" class="auth-logo-light">
                                    <div class="avatar-md profile-user-wid mb-4">
                                        <span class="avatar-title rounded-circle bg-light">
                                            <img src="<?= base_url() ;?>vendor/assets/images/logo-light.svg" alt="" class="rounded-circle"
                                                height="34">
                                        </span>
                                    </div>
                                </a>
                                ...
                                <a href="index.html" class="auth-logo-dark">
                                    <div class="avatar-md profile-user-wid mb-4">
                                        <span class="avatar-title rounded-circle bg-light">
                                            <img src="<?= base_url() ;?>vendor/assets/images/logo.svg" alt="" class="rounded-circle" height="34">
                                        </span>
                                    </div>
                                </a>
                            </div>
                            <div class="p-2">
                                <form class="form-horizontal" action="#" id="formLogin" name="formLogin" accept-charset="utf-8" method="post">
                                    ...
                                    <div class="mt-3 d-grid">
                                        <button class="btn btn-primary waves-effect waves-light btn-login" id="btnLogin">Log
                                            In</button>
                                    </div>
    ...
    <script type="text/javascript">
    	...
    	$('#btnLogin').on('click',  function() {
    		...
    		$.ajax({
    			url: siteUrl+'login/Login/do_login',
    			type: 'POST',
    			dataType: 'json',
    			data: formData,
    			processData: false,
